...
if __name__ == '__main__':
    ...
    if args.bro_log:
        ...
        df_cache = dataframe_cache.DataFrameCache(max_cache_time=60)  # 60 second cache
        ...
        for row in reader.readrows():
            ...
            if time.time() > timer:
                ...
                # Get the windowed dataframe (60 second window)
                ...
                odd_clf = IsolationForest(contamination=0.05) # Marking 5% as odd
